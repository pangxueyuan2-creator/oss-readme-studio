...
const starter: ProjectForm = {
  ...
  install: "git clone https://github.com/your-name/your-project.git\ncd your-project\nnpm install",
  usage: "npm run dev",
  author: "Your Name",
...
function makeReadme(form: ProjectForm, bilingual: boolean) {
...
MIT © ${new Date().getFullYear()} ${form.author.trim() || "Project contributors"}`;
...
export default function Home() {
  const [form, setForm] = useState<ProjectForm>(starter);
    ...
    <main>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-meta">
          <span>01 — Describe</span><i />
          <span>02 — Preview</span><i />
      ...
      <section className="workspace" aria-label="README generator">
        <div className="panel form-panel">
          <div className="panel-heading">
            ...
            <button className="text-button" onClick={() => setForm(starter)}>Reset</button>
          </div>
